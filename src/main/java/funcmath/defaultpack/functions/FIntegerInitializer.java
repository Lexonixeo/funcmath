...
public class FIntegerInitializer extends Initializer {
    ...
    protected void initSimpleFunctions() throws NoSuchMethodException {
        SimpleFunction sum = new SimpleFunction("sum", FInteger.class.getMethod("sum", FInteger.class, FInteger.class));
        String sumHash = sum.getHash().toString();
        SimpleFunctionRegister.registerSimpleFunction(sum);

        SimpleFunction sub = new SimpleFunction("sub", FInteger.class.getMethod("sub", FInteger.class, FInteger.class));
        String subHash = sub.getHash().toString();
        SimpleFunctionRegister.registerSimpleFunction(sub);

        SimpleFunction mul = new SimpleFunction("mul", FInteger.class.getMethod("mul", FInteger.class, FInteger.class));
    ...
    protected void initTypeAndConverts() throws NoSuchMethodException {
        ...
        TypeRegister.registerConvert(new FInteger(), new FNatural(), this.getClass().getMethod("convertFintFnat", FInteger.class));
        TypeRegister.registerConvert(new FNatural(), new FInteger(), this.getClass().getMethod("convertFnatFint", FNatural.class));
    }
