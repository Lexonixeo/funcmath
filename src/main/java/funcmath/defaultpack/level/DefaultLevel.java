...
public class DefaultLevel implements Level {
    ...
    private DefaultLevel(DLInfo li) {
        ...
        this.panel = new GConsoleLevelPanel() {
            @Override
            protected void game() {
    ...
    public ArrayList<MathObject> compute(ArrayList<String> expression) {
                        ...
                        try {
                            ans =
                                    fStack
                                            .peek()
                                            .use(
                                                    levelInfo.getRules().infinityFunctions(),
        ...
        newNumbers.addAll(numsStack.peek());
        currentLevelState = new DLState(levelInfo, currentLevelState.getHistory(), newNumbers, newFunctions);
