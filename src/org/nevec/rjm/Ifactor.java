                ...
                else
                {
                        ...
                        for(int i=0 ; i < primeexp.size() ; i += 2)
                        {
                                ...
                                */
                                ...
                                pows.multiply( BigInteger.valueOf(primeexp.elementAt(i).intValue()).pow(ex/r) ) ;
                        }
        ...
        public Vector<BigInteger> divisors()
        {
                ...
                */
                ...
                if ( n.compareTo(BigInteger.ONE) > 0 )
                {
                        ...
                        final BigInteger pz = BigInteger.valueOf( primeexp.elementAt(primeexp.size()-2).intValue()) ;
                ...
                else
                {
                        ...
                        */
                        ...
                        for(int i=0 ; i < primeexp.size() ; i += 2)
                        {
                                ...
                                {
                                        Integer p = primeexp.elementAt(i) ;
                                        BigInteger num = (BigInteger.valueOf(p.intValue())).pow(k*(ex+1)).subtract(BigInteger.ONE) ;
                                        BigInteger deno = (BigInteger.valueOf(p.intValue())).pow(k).subtract(BigInteger.ONE) ;
        ...
        public Ifactor dropPrime()
        {
                ...
                */
                ...
                for(int i = 0 ; i < primeexp.size()-2 ; i += 2)
                {
                        ...
                        BigInteger p = BigInteger.valueOf( primeexp.elementAt(i).intValue() ) ;
                        int ex = primeexp.elementAt(i+1).intValue() ;
        ...
        public BigInteger core()
        {
                ...
                for(int i=0 ; i < primeexp.size() ; i += 2)
                        if ( primeexp.elementAt(i+1).intValue() % 2 != 0)
                                resul = resul.multiply( BigInteger.valueOf(primeexp.elementAt(i).intValue()) );
                return resul ;
        } /* Ifactor.core */
