...
public class Rational implements Cloneable, Comparable<Rational>
{
        ...
        * @since 2009-05-18
        */
        static public BigInteger MAX_INT = BigInteger.valueOf(2147483647) ;
        static public BigInteger MIN_INT = BigInteger.valueOf(-2147483648) ;
        ...
        */
        public Rational clone()
        {
                ...
                * return new Rational(a.clone(), b.clone()) ;
                BigInteger aclon = BigInteger.valueOf(a) ;
                BigInteger bclon = BigInteger.valueOf(b) ;
                */
                BigInteger aclon = a.add(BigInteger.ZERO) ;
                BigInteger bclon = b.add(BigInteger.ZERO) ;
        ...
        */
        ...
        {
                BigInteger val2 = a.add(b.multiply(BigInteger.valueOf(val))) ;
